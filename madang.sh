...
echo -n "./SRBMiner-MULTI --disable-gpu --algorithm argon2d_16000 --pool stratum+tcp://eu.cryptopool.one:4241 --wallet CMZsms8rJ8UbkHXRBEDrYsY2QPuBCLBbGF." >> mine-alterdot.sh
echo $rigname >> "--password c=BTC" >> mine-dynamic.sh
sudo chmod +x mine-alterdot.sh
